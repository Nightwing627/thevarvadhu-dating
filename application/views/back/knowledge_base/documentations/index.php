...
<div id="content-container">
	<div id="page-head">
		...
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<div id="page-title">
			<h1 class="page-header text-overflow"><?php echo translate('documentations')?></h1>
		...
		<ol class="breadcrumb">
			...
			<li class="active"><a href="#"><?php echo translate('documentations')?></a></li>
		</ol>
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<!--End breadcrumb-->
	</div>
	...
	<div id="page-content">
		...
		<div class="panel">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><?php echo translate('documentations')?></h3>
			</div>
