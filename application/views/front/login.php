...
<html>
    ...
    <body>
        ...
        <section class="slice-lg has-bg-cover bg-size-cover" style="background-image: url(<?php echo base_url()?>uploads/login_image/<?php echo $login_image_data[0]['image']?>); background-position: bottom bottom;">
                            ...
                            <div class="form-body">
                                <div class="text-center px-2">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <p class="text-success"><?php echo $register_success?></p>
                                        <?php
                                        }
                                    ?>
                                </div>
                                <form class="form-default" role="form" method="post" action="<?php echo base_url()?>home/check_login">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="text-uppercase font_light"><?php echo translate('email/member_id')?></label>
                                    ...
                                    <div class="row pt-3">
                                        ...
                                        <div class="col-6 text-right" style="font-size: 12px;">
                                            <a href="<?php echo base_url()?>home/forget_pass" class="c-gray-light"><?php echo translate('recover_password')?></a>
                                        </div>
                                    </div>
                                </form>
                                <div class="row">
                        ...
                        <?php if(demo()){ ?>
                            ...
                            <div class="form-body">
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="button" class="btn btn-styled btn-sm btn-block btn-base-1 z-depth-2-bottom mt-4 cpy_btn"><?php echo translate('copy')?></button>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
