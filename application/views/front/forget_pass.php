                    ...
                    <div class="col-lg-4 col-md-6 ml-auto mr-auto">
                        <div class="form-card form-card--style-2 z-depth-3-top">
                            <div class="form-body">
                                ...
                                <form class="form-default" role="form" method="post" action="<?php echo base_url()?>home/forget_pass/forget">
                                    <div class="row">
                                        <div class="col-12">
                                    ...
                                    <div class="row pt-3">
                                        <div class="col-12 text-center" style="font-size: 12px;">
                                            <a class="c-gray-light" href="<?php echo base_url()?>home/login">Log In Page</a>
                                        </div>
                                    </div>
                                </form>
                                <div class="row mt-3">
