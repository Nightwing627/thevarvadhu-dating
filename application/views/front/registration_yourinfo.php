									...
									<div class="reg_pad1 fontreg">
										<div class="brdrb_1">
											<div class="fullwid txtc f15 tabone clearfix">
												<a style="cursor:default" class="fl reg_active text-success">Your Information</a>
											</div>
										</div>
									</div>
								</center>
                                <form class="form-default mt-3" id="register_form" method="post" action="<?php echo base_url()?>home/display_yourinfo">
                                    <div class="row justify-content-center">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                             <label class="control-label font_light"><?php echo "Member ID" ?></label>
                                                <input type="text" readonly class="form-control form-control-sm p-2" name="member_profile_id" value="<?php echo $member_profile_id ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
                                        <div class="col-md-6">
                                            <div class="form-group">                                            
                                                <label class="control-label font_light"><?php echo "Password" ?></label>
                                                <input type="text" readonly class="form-control form-control-sm p-2" name="orig_password" value="<?php echo $orig_password ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
