									...
									<div class="reg_pad1 fontreg">
										<div class="brdrb_1">
											<div class="fullwid txtc f15 tabone clearfix">
												...
												<a style="cursor:default" class="fl ">Contact Detail</a>
											</div>
										</div>
									</div>
								</center>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="family_values" required class="form-control form-control-sm" data-placeholder="Choose your family values" >
													<option value="">Choose one</option>
													<?php 
														foreach ($family_values as $k => $v) {
															?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="family_status" required class="form-control form-control-sm" data-placeholder="Choose your family status" >
													<option value="">Choose one</option>
													<?php 
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="no_brothers" required class="form-control form-control-sm" data-placeholder="Choose your number of brothers" >
													<option value="">Choose one</option>
													<?php 
														foreach ($no_brothers as $k => $v) {
															?>
																<option value="<?php echo $v->id; ?>"><?php echo $v->display;  ?></option>
															<?php
														}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="no_married_brothers" required class="form-control form-control-sm" data-placeholder="Choose number of married brothers" >
													<option value="">Choose one</option>
													<?php 
														foreach ($no_brothers as $k => $v) {
															?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="no_sisters" required class="form-control form-control-sm" data-placeholder="Choose your number of sisters" >
													<option value="">Choose one</option>
													<?php 
														foreach ($no_brothers as $k => $v) {
															?>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="no_married_sisters" required class="form-control form-control-sm" data-placeholder="Choose number of married sisters" >
													<option value="">Choose one</option>
													<?php 
														foreach ($no_brothers as $k => $v) {
															?>
