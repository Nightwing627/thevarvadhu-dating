                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Education" ?></label>
                                                <select name="education" required class="form-control form-control-sm" data-placeholder="Choose a Education" >
													<option value="">Choose one</option>
													<?php 
														foreach ($education as $kk => $vv) {
															?>
																<option value="<?php echo $vv->education_id; ?>"><?php echo $vv->name;  ?></option>
															<?php
														}
													?>
        ...
        <script type="text/javascript">
            ...
            function fetchCity() {
                ...
                $.ajax({
                    ...
                    data:{table: 'city', field:'state_id', id: state_id},
