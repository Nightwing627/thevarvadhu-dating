                    ...
                    <div class="col-lg-7 col-md-10 ml-auto mr-auto">
                        <div class="form-card form-card--style-2 z-depth-3-top">
                            <div class="form-body">
                                ...
                                <form class="form-default mt-4" id="register_form" method="post" action="<?php echo base_url()?>home/registration/submit_contact_detail">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Address" ?></label>
                                                <input name="address" required class="form-control form-control-sm" placeholder="Please insert address" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="state" required class="form-control form-control-sm" data-placeholder="Choose a state" id="state">
													<option value="">Choose one</option>
													<?php 
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo translate('City') ?></label>
                                                <select name="city" required class="form-control form-control-sm" id="city">
													<option value="">Choose one</option>
												</select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Mobile2" ?></label>
                                                <input type="number" name="mobile2" required class="form-control form-control-sm">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="residence" required class="form-control form-control-sm">
													<option value="">Select Residence</option>
													<?php 
														foreach ($residences as $k => $v) {
															?>
																<option value="<?php echo $v->residence_id; ?>"><?php echo $v->name;  ?></option>
															<?php
														}
													?>
												</select>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $('#state').on('change',function(){
                 	...
                 	console.log(stateId);
                  	$.ajax({
                        url:"<?php echo base_url()?>home/get_dropdown_by_id_city",
                        method:"POST",
